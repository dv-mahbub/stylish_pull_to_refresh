...
class StylishPullToRefresh extends StatefulWidget {
  ...
  const StylishPullToRefresh.adaptive({
    super.key,
    required this.child,
    this.displacement = 40.0,
    this.edgeOffset = 0.0,
...
class RefreshIndicatorState extends State<StylishPullToRefresh>
    with TickerProviderStateMixin<StylishPullToRefresh> {
  ...
  @override
  void didUpdateWidget(covariant StylishPullToRefresh oldWidget) {
  ...
  Widget build(BuildContext context) {
      ...
      child: NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: Stack(
          children: [
            widget.child,
            Visibility(
              visible: _mode == _RefreshIndicatorMode.refresh,
    ...
    final bool showIndeterminateIndicator = _mode == _RefreshIndicatorMode.done;
                ...
                child: ScaleTransition(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (BuildContext context, Widget? child) {
                      final Widget
                          materialIndicator = //RefreshProgressIndicator(
                          ...
                          // );
                          showIndeterminateIndicator ? Container() : design();
  ...
  Widget design() {
    switch (widget.style) {
      ...
      case Style.fileSearch:
        return customSizedBox('fileSearch');
      ...
      case Style.loop:
        return customSizedBox('loop');

      case Style.paperPlane:
        return customSizedBox('paperPlane');

      // case Style.child:
      //   return widget.child;

      case Style.sandTimer:
        return customSizedBox('sandTimer');

      case Style.threeCircle:
        return customSizedBox('threeCircles');
